...
/* System Control base address of 0x400FE000 */

#define SYSCTL_MOSCCTL_REG        (*((volatile unsigned long *)0x400FE07C))
/*RCGC0 RCGC1 RCGC2 This registers control the clock gating logic in normal Run mode. Each bit controls a clock enable
for a given interface, function, or module. If set, the module receives a clock and functions.*/
